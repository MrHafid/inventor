                 ...
                 ?>	
				   <div id="block_bg" class="block">
                        <div class="navbar navbar-inner block-header">
                             <div class="muted pull-left"><i class="icon-reorder icon-large"></i> Monitor (s) List</div>
							 <div class="muted pull-right">
								Number of Monitor (s): <span class="badge badge-info"><?php  echo $count; ?></span>
							 </div>
                          </div>
						  
				<h4 id="sc">Monitor (s) List
 ...
 <br/>
	<div class="pull-left">
			  ...
			  <?php	
               ...
               ?>
				<li class="">
				<a href="Mouse.php">Mouse&nbsp;<span class="label label-default"> <?php echo $count;?></span></a>
				</li>
