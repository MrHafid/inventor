                 ...
                 ?>	  
				   ...
				   <div id="block_bg" class="block">
                        <div class="navbar navbar-inner block-header">
                             <div class="muted pull-left"><i class="icon-check"></i>&nbsp;New Mouse (s) List</div>
							 <div class="muted pull-right">
								Number of New Mouse (s): <span class="badge badge-info"><?php  echo $count; ?></span>
							 </div>
                          </div>
						  
				<h4 id="sc">New Mouse (s) List
