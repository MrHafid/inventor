								...
								<form action="delete_dev_name.php" method="post">
									...
									<?php include('modal_delete.php'); ?>
										...
										<tbody>
												...
												<td width="75">
												<a rel="tooltip"  title="Edit Device Name" id="e<?php echo $id; ?>" href="edit_dev_name.php<?php echo '?id='.$id; ?>"  data-toggle="modal" class="btn btn-success"><i class="icon-pencil icon-large"> Edit</i></a>
												</td>
