...
<html class="no-js">
    <head>
        ...
        <!-- Bootstrap -->
			...
			<link href="../images/logo.png" rel="icon" type="image">
			<link href="../admin/bootstrap/css/print_background.css" rel="stylesheet" media="screen">
			<link href="../admin/bootstrap/css/bootstrap.min.css" rel="stylesheet" media="screen">
			<link href="../admin/bootstrap/css/bootstrap-responsive.css" rel="stylesheet" media="screen">
			<link href="../admin/bootstrap/css/bootstrap-responsive.min.css" rel="stylesheet" media="screen">
			<link href="../admin/bootstrap/css/font-awesome.css" rel="stylesheet" media="screen">
			<link href="../admin/bootstrap/font-awesome-4.1.0/css/font-awesome.min.css" rel="stylesheet" type="text/css">
			<link href="../admin/bootstrap/css/my_style.css" rel="stylesheet" media="screen">
			<link href="../admin/assets/styles.css" rel="stylesheet" media="screen">	
			<link href="../admin/bootstrap/css/print_inventory.css" rel="stylesheet" media="print">						
